...
class hkpGunProjectile : public hkReferencedObject, public hkpCollisionListener
{
 	public:
	...
	public:
		...
		virtual void onHit(hkpContactPointConfirmedEvent& event) { m_flags.orWith(HIT); }
			/// Called on an update
	...
	private:
		...
		virtual void contactPointConfirmedCallback( hkpContactPointConfirmedEvent& event) { onHit(event); }
