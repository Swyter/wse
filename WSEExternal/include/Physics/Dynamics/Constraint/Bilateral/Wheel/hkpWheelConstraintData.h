...
class hkpWheelConstraintData : public hkpConstraintData
{
	public: 
		...
		hkpWheelConstraintData();
			...
			/// \param bodyA				The attached body, ie the wheel.
			/// \param bodyB				The reference body, ie the chassis.
		...
		void setInWorldSpace(const hkTransform& bodyATransform, const hkTransform& bodyBTransform, 
			...
			/// Sets the wheel up with with body space information. The Wheel is A, the Chassis is B.
			/// \param bodyA				The attached body, ie the wheel.
			/// \param bodyB				The reference body, ie the chassis.
