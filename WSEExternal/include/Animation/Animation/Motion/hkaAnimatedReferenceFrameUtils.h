...
public:
	...
	static void HK_CALL transformIntoAnimatedReferenceFrame( const class hkaAnimatedReferenceFrame* motion, class hkQsTransform* transformsInOut, int m_numTransforms, int stride);
};
