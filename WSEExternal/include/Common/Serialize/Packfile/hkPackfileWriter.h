...
class hkPackfileWriter : public hkReferencedObject
{
	public:
		...
		private:
			HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR( HK_MEMORY_CLASS_SERIALIZE, hkPackfileWriter::Options );
		};
	...
	protected:
		...
		hkPointerMultiMap<const void*, int> m_pwIndexesFromReferencedPointer; // list of pending write indexes of pointers referenced by key, like a typological map
};
