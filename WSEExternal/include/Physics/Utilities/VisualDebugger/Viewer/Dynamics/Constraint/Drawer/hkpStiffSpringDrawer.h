...
#ifndef HK_STIFFSPRINGDRAWER_H
#define HK_STIFFSPRINGDRAWER_H
...
{
	public:
		HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR( HK_MEMORY_CLASS_VDB, hkpStiffSpringDrawer );

		void drawConstraint(hkpConstraintInstance* constraint, hkDebugDisplayHandler* displayHandler, int id, int tag);
};

#endif //HK_STIFFSPRINGDRAWER_H
