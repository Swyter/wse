...
public:
	...
	static HK_FORCE_INLINE void convertProjectedEntryToHkVector4(const hkKdTreeBuildInput::ProjectedEntry* splits, hkVector4& v1, hkVector4& v2);
	static HK_FORCE_INLINE void getAabbFromProjectedEntry(const hkKdTreeBuildInput::ProjectedEntry* aabbData, hkAabb& aabb, hkVector4Parameter offset, hkVector4Parameter _scale);
	static HK_FORCE_INLINE void getAabbVecsFromProjectedEntry(const hkKdTreeBuildInput::ProjectedEntry* aabbData, hkVector4* HK_RESTRICT vecsOut, hkVector4Parameter offset, hkVector4Parameter scaleIn);
