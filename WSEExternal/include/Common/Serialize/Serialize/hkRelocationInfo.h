...
class hkClass;
template<typename t> class hkStorageStringMap;	
...
class hkRelocationInfo
{
	public:
		...
		struct Global
		{
			...
			hkBool32 m_related;
		private:
			HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR( HK_MEMORY_CLASS_SERIALIZE, hkRelocationInfo::Global );
		};
		...
		private:
			HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR( HK_MEMORY_CLASS_SERIALIZE, hkRelocationInfo::Finish );
		};
		...
		private:
			HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR( HK_MEMORY_CLASS_SERIALIZE, hkRelocationInfo::Import );
		};
