...
/// Notes:
/// <ul>
///   <li>All broadphase objects in the havok world are actually members of hkpCollidable objects.
...
///   <li>All hkpPhantom objects use the hkpWorld::getCollisionFilter as the filter for broadphase updates, and shape queries. The one notable
