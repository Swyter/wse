...
/// The base class to collect hkContactPoint and hkpCdBody information from the collision detection<br>
...
class hkpCdPointCollector
{
	public:
		...
		inline virtual ~hkpCdPointCollector();
			...
			/// Note that setting this value has *no* optimization effect for eg. getClosestPoints() calls.
