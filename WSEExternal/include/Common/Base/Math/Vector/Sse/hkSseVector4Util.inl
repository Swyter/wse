...
{
	register hkQuadReal c0 = _mm_mul_ps( a0.getQuad(), vectorIn.getQuad());
	register hkQuadReal c1 = _mm_mul_ps( a1.getQuad(), vectorIn.getQuad());
	register hkQuadReal c2 = _mm_mul_ps( a2.getQuad(), vectorIn.getQuad());
	register hkQuadReal c3 = _mm_mul_ps( a3.getQuad(), vectorIn.getQuad());
