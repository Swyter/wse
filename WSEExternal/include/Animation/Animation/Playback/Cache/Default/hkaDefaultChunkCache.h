...
class hkaDefaultChunkCache : public hkaChunkCache
{
	public:
		...
		virtual hkBool isKeyLockedForWrite( hkUint32 key, hkUint32 chunkSize ) { return false; }
			...
			/// Critical section enter (no implemention for this class - use hkaMultithreadedDefaultChunkCache)
		virtual void enterCriticalSection( ) {}

			/// Critical section leave (no implemention for this class - use hkaMultithreadedDefaultChunkCache)
