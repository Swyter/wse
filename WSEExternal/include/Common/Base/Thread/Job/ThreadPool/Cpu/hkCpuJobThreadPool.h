...
struct hkCpuJobThreadPoolCinfo
{
	...
	int m_timerBufferPerThreadAllocation;
		...
		/// Whether to set large memory blocks, needed by Havok physics during multithreading simulation,
		/// during multithreaded constraint solve. This defaults to true.
