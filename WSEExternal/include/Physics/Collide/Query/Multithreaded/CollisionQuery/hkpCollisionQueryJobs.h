...
struct hkpCollisionQueryJob : public hkJob
{
	public:
		...
		enum JobSubType
		{
			...
			COLLISION_QUERY_KD_TREE_LINEAR_CAST_JOB,
...
// ===============================================================================================================================================================================================
//   KD-TREE WORLD LINEAR CAST QUERY
// ===============================================================================================================================================================================================
...
public:
	...
	HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR( HK_MEMORY_CLASS_COLLIDE, hkpKdTreeLinearCastJob );
	enum { MAXIMUM_NUMBER_OF_COMMANDS_PER_TASK = 256 };
