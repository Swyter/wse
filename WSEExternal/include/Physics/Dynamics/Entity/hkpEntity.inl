...
inline const hkSmallArray<hkpCollisionListener*>& hkpEntity::getCollisionListeners() const
{
#ifdef HK_DEBUG_MULTI_THREADING
	checkReadOnly();
#endif
...
inline bool hkpEntity::areCollisionListenersAdded() const
{
	return m_collisionListeners.getSize() > 0;
}

inline hkUint16 hkpEntity::getProcessContactCallbackDelay() const
{
	return m_processContactCallbackDelay;
}

inline void hkpEntity::setProcessContactCallbackDelay( hkUint16 delay )
{
