...
#ifndef HK_RAGDOLL_LIMITS_DRAWER_H
#define HK_RAGDOLL_LIMITS_DRAWER_H
...
{
	public:
		HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR( HK_MEMORY_CLASS_VDB, hkpRagdollLimitsDrawer );
...
#endif //HK_RAGDOLL_LIMITS_DRAWER_H
