...
#ifndef HK_POINTTOPLANEDRAWER_H
#define HK_POINTTOPLANEDRAWER_H
...
{
	public:
		HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR( HK_MEMORY_CLASS_VDB, hkpPointToPlaneDrawer );

		void drawConstraint(hkpConstraintInstance* constraint, hkDebugDisplayHandler* displayHandler, int id, int tag);
};

#endif //HK_POINTTOPLANEDRAWER_H
